package com.spring.webflux.webclient.controller;
...
import com.spring.webflux.webclient.service.GithubClient;
...
public class GithubController {
	...
	public Mono<GithubRepo> editGithubRepository(@PathVariable String repo,
			@Valid @RequestBody RepoRequest repoRequest) {
